    ...
    */
    ...
    public:
        ...
        */
        ...
        double user_predict(array_1d<double>&,double*,int,int*,int) const;
        
        /*does not calculate sigma (which can be verytime consuming). The int is verbosity*/
        double user_predict(array_1d<double>&,int,int*,int) const;
        ...
        double user_predict(array_1d<double>&,int,array_1d<double>&,int*,int) const;
        
        /*returns sigma in the double* and the values of the function used for
        interpolation in the final array_1d<double>; the int is for verbosity*/
        double user_predict(array_1d<double>&,double*,int,array_1d<double>&,int*,int) const;
    ...
    private:
        ...
        double predict(array_1d<double>&,double*,int,int,array_1d<double>&, int*, int) const;
